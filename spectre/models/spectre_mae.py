...
class ChannelSpatialAttentionBlock(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.channel_transformer = Block(embed_dim=embed_dim,
                                         num_heads=num_heads,
                                         mlp_ratio=mlp_ratio,
                                         qkv_bias=True,
                                         qk_scale=None,
                                         norm_layer=norm_layer)
        self.spatial_transformer = Block(embed_dim=embed_dim,
                                        num_heads=num_heads,
                                        mlp_ratio=mlp_ratio,
                                        qkv_bias=True,
                                        qk_scale=None,
...
class SpectreMaskedAutoencoderViT(L.LightningModule):
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            ChannelSpatialAttentionBlock(embed_dim, num_heads, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer)
        ...
        self.decoder_blocks = nn.ModuleList([
            ChannelSpatialAttentionBlock(decoder_embed_dim, decoder_num_heads, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer)
    ...
    def forward_encoder(self, x_he, x_codex, mask_ratio):
        ...
        x_codex = x.view(x_codex.shape[0]*x_codex.shape[1], x_codex.shape[2], x_codex.shape[3]) # [N*C, H, W]
        ...
        x_codex = x_codex.view(x.shape[0], x.shape[1], x_codex.shape[1], x_codex.shape[2]) # [N, C, L, D]
